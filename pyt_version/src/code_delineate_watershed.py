...
def delineate(workspace, delineation_name, save_intermediate_outputs):
    try:
        arcpy.env.workspace = workspace
        ...
        outlet_pour_point = arcpy.sa.SnapPourPoint(outlet_point_geometry, fa_raster, snap_radius, "#")
